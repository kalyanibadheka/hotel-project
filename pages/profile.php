							...
							<?php if( isset($_SESSION['email']) && !empty($_SESSION['email']) )
{
	...
	?>
            ...
            <ul class="list-group">
                <li class="list-group-item  fs-5 text-center fw-bold bg-light">Profile</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>NAME: </strong></span> <?php echo $title; ?> </li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Email: </strong></span> <?php echo $email; ?></li>
        ...
        <div class="col-sm-9 text-center">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
					...
					<?php
				$bk=mysqli_query($con,"select * from room where email='".$_SESSION['email']."'");
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody id="items">
								...
								while($bkg=mysqli_fetch_array($bk))
								{
									?>
                                <tr>
                                    <td><?php echo $bkg['room_id'];?></td>
									<td><?php echo $bkg['type'];?></td>
                                    <td><?php echo $bkg['fname'].$bkg['lname'];?></td>
                                 
									<td><?php echo $bkg['address'];?></td>
									<td><?php echo $bkg['email'];?></td>
									<td><?php echo $bkg['number'];?></td>
									<td><?php echo $bkg['nrooms'];?></td>
									<td><?php echo $bkg['checkin'];?></td>
									<td><?php echo $bkg['checkout'];?></td>
									<td><?php echo $bkg['total']?></td>
