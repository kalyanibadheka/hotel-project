...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if($emailcount>0) {
               ...
               $subject = "password reset";
                ...
                http://localhost/resort%20project/pages/reset.php?token=$token";
							...
							<?php if( isset($_SESSION['email']) && !empty($_SESSION['email']) )
{
        ...
        <form action="forgot-password.php" class="sign-up-form" method="post">
        ...
        <input class="form-control btn" type="submit"  name="check-email" value="Continue">
