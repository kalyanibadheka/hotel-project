        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4 fw-600">
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="../pages/login-user.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Order Now</a>
                        </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            ...
                            require '../pages/config.php';
                                $selectquery = "select * from dishes LIMIT 4";
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <h5><a href="cart.php?res_id='.$result['rs_id'].'">'.$result['title'].'</a></h5>
                                                <span class="text-primary" href="cart.html"> '.$result['price'].'</span> 
                                            </h5>
