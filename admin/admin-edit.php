...
$query ="UPDATE `admin` SET uname='$uname',email='$email',password='$password' WHERE id='$admin_id'";
...
<input type="hidden" name="admin_id" value="<?php echo $row['id']?>"/>
                              ...
                              <div class="form-outline mb-4">
                                  <input type="text" name="uname" id="form3Example1cg" value="<?php echo $row['uname'] ?>" class="form-control form-control-lg" />
