...
<a href="insertimages.php" type="button" class="btn btn-secondary mt-4 mb-4" name="add">ADD ROOMS</a>
<!-- <table>
   <thead>
       <tr>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $con->query("SELECT * FROM registration order by id asc");
								...
								<tr>
									...
									<td class="text-center">
										<img src="../admin/upload/<?php echo isset($row['pic']) ? ''.$row['pic'] :'' ?>" alt="" id="cimg">
									</td>
									<td class="">
										<p>Name : <b><?php echo $row['type'] ?></b></p>
                          ...
                          <a href="room_edit.php?id=<?php echo $row['id'];?>" class="btn btn-sm btn-primary edit_cat mr-2"> EDIT </a>
