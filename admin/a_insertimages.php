      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="container">
  <div class="row">  
<form action="a_upload.php" method="POST" class="mx-auto mt-5" enctype="multipart/form-data">
<div class="card">
      <div class="card-header"><b>Add dishes</b></div>


        <div class="card-body">
        <div class="form-group">
            <label for="exampleInputName">Dish id</label>
            <input type="text" name="rs_id" class="form-control" id="exampleInputName" placeholder="Dish Id" required="required">
          </div>
          <div class="form-group">
            <label for="exampleInputName">Dish Name</label>
            <input type="text" name="title" class="form-control" id="exampleInputName" placeholder="Dish Name" required="required">
          </div>
          <div class="form-group">
            <label for="exampleInputName">Discription</label>
            <input type="text" name="slogan" class="form-control" id="exampleInputName" placeholder="Discription" required="required">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <img src="<?php echo isset($image_path) ? 'upload/dishes/'.$cover_img :'' ?>" alt="" id="cimg">
          </div>
