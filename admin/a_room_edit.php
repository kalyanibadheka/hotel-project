...
<form action="a_update.php" class="mx-auto mt-5" method="POST" enctype="multipart/form-data">


<input type="hidden" name="d_id"  value="<?php echo $row['d_id']; ?>" >
<div class="card">
      <div class="card-header">Dishes Update Form</div>
      <div class="card-body">  
          <div class="form-group">
            <label for="exampleInputName">Dish Name</label>
            <input type="text" name="title" value="<?php echo $row['title']; ?>" class="form-control" id="exampleInputName" placeholder="type" required="required">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
           ...
           <img src="../admin/upload/dishes/<?php echo $row['img']; ?>" width="100px">
