      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="container">
  <div class="row">  
<form action="update.php" method="POST" class="mx-auto mt-5" enctype="multipart/form-data">
<div class="card">
      <div class="card-header"><b>Add Room Form</b></div>


        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputName">Room Name</label>
            <input type="text" name="type" class="form-control" id="exampleInputName" placeholder="Room Name" required="required">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <img src="<?php echo isset($image_path) ? 'upload/'.$cover_img :'' ?>" alt="" id="cimg">
          </div>
