      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
               ...
               ?>
                <!-- end topbar -->
               <a href="add-admin.php" type="button" name="add" class="btn btn-secondary mt-4 mb-4">ADD NEW ADMIN</a>
  ...
  if(mysqli_num_rows($query_run)>0)
  {
     ...
     <tr>
       ...
       <td class="d-flex justify-content-center">
          <a href="admin-edit.php?admin_id=<?php echo $row['id']; ?>" class="btn btn-success mr-2">Edit</a>
